...
const FeatureCard311 = (props) => {
  return (
    <div className={`feature-card311-feature-card ${props.rootClassName} `}>
      ...
      <h2 className="feature-card311-text1">{props.title1}</h2>
      <span className="feature-card311-text2">{props.description}</span>
      <span className="feature-card311-text3">{props.description2}</span>
      <span className="feature-card311-text4">{props.description1}</span>
      <span className="feature-card311-text5">{props.action}</span>
    </div>
  )
}
