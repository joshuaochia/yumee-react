          ...
          <div className="page1-links-container">
            ...
            <div className="page1-container2">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer noopener"
                className="page1-link07"
              >
                Terms and conditions
              </a>
            </div>
          </div>
          <div className="page1-follow-container">
            ...
            <div className="page1-icons-container">
              <a
                href="https://www.instagram.com/myjoyfulhearts_hcs"
                target="_blank"
                rel="noreferrer noopener"
                className="page1-link08"
              >
                <svg
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer noopener"
                className="page1-link09"
              >
                <svg
                  viewBox="0 0 602.2582857142856 1024"
                  className="page1-icon2"
                >
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer noopener"
                className="page1-link10"
              >
                <svg
                  viewBox="0 0 950.8571428571428 1024"
                  className="page1-icon4"
                >
